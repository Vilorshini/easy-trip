...
takamaka = Activity.create(
  ...
  address: "Mare aux Vacoas, Vacoas-Phoenix, Mauritius",
...
joliette = Activity.create(
  ...
  address: "Petite Riviere, Mauritius",
...
street = Activity.create(
  ...
  address: "Caudan, Port Louis, Mauritius",
...
culinary = Activity.create(
  ...
  address: "123 Avenue des Oies, Flic en Flac, Mauritius",
...
laser = Activity.create(
  category_id: team.id,
  name: "Laser Tag Game",
  address: "William Newton Avenue, Quatre Bornes, Mauritius",
...
pirate = Activity.create(
  ...
  address: "Belle Mare, Flacq, Mauritius",
...
aapravasi = Activity.create(
  ...
  name: "Aapravasi Ghat",
  address: "1 Quay Street, Port Louis, Mauritius",
...
botanic = Activity.create(
  ...
  address: "Sir Seewoosagur Ramgoolam Botanical Garden, Pamplemousses, Mauritius",
...
aubin = Activity.create(
  category_id: culture.id,
  name: "Saint Aubin, Savanne Road, Mauritius",
  address: "Saint Aubin, Savanne Road, Mauritius",
...
av_sucre = Activity.create(
  ...
  address: "L'Aventure du Sucre, Pamplemousses, Mauritius",
...
grandbassin = Activity.create(
  category_id: culture.id,
  name: "Grand Bassin",
  address: "B88, Grand Bassin, Mauritius",
...
craft = Activity.create(
  ...
  address: "Marine Quay, Port Louis, Mauritius",
...
hike_chamarel = Activity.create(
  ...
  address: "Waterfall, Chamarel, Mauritius",
